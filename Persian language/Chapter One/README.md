...
می کنند تا برنامهی مورد نظر را ایجاد کنند(با کامپیوتر صحبت می کنند). این دستورالعملها ممکن است شامل 
محاسبات ریاضی، داده پردازی ، مدیر یت فایل، شبکه و بسیار ی از سایر عملیات باشن
