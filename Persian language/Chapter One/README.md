...
## 🔰 برنامه نویسی چیست؟
> برنامه نویسی فرآ یند نوشتن کد )متن( برا ی ساختن نرم افزارها، برنامه ها، وبسایت ها و اپلی کی شن ها ی موبا یل 
است. به طور کلی، برنامه نویسان با استفاده از ی ک زبان برنامه نویس ی، دستورالعمل هایی برا ی کامپیوتر ایجاد 
می کنند تا برنامه ی مورد نظر را ایجاد کنند) با کامپیوتر صحبت م ی کنند (. این دستورالعملها ممکن است شامل 
محاسبات ر یاضی، دادهپردازی ، مدیر یت فای ل، شبکه و بس یار ی از سایر عمل یات باشن
